...
function Tickets_tech() {
    ...
    return <div className="flex flex-col justify-center items-center w-full p-10 gap-10">
        <button onClick={navigate('/bookTicket')} className='w-32 p-3 bg-green-500 text-white text-xl rounded-[8px] transition-all duration-300 hover:scale-105'>Book Ticket</button>
